...
exports.handler = async (event, _context) => {
    ...
    const response1 = await request_1.request(new url_1.URL(`${objectId}.html`, baseURL), streamReader_1.asString);
    ...
    return {
        statusCode: 200,
        headers: Object.assign({}, filterHeadersForAPIGateway_1.filterHeadersForAPIGateway(response2.headers), generateCORSHeaders_1.generateCORSHeaders(event), { 'content-length': body.length, 'content-type': 'application/json; charset=utf-8', 'cache-control': 'max-age=43200' }),
        body,
    };
};
